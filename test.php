            ...
            if (!isset($_POST['time_slot']) || empty($_POST['time_slot'])) {
                ...
                if ($stmt = $conn->prepare($sql)) {
                    ...
                    if ($stmt->execute()) {
                        ...
                        // Inserimento dei servizi selezionati per l'appuntamento
                        if (isset($_POST['checkboxes']) && is_array($_POST['checkboxes'])) {
                            ...
                            if ($stmt2 = $conn->prepare($sql2)) {
                                ...
                                $message .= "Errore nella preparazione della query per i servizi.<br>";
                            }
                        } else {
                            $message .= "Nessun servizio selezionato.<br>";
                        }
                    } else {
                    ...
                    $message .= "Errore nella preparazione della query per l'appuntamento.<br>";
                }
            }
        }
    } else {
